/* BName 20/01/2024
 ...
 quote ['] (NB [‘] is a different character) and mapping, in a transparent manner, 
 non-ASCII characters such as à => a and á => a 
...
std::map<std::string, std::string> BName::m_match;
...
std::string
BName::remove_accents( std::string str )
...
std::string
BName::clean( const std:: string& str ) 
// remove newlines and escape single quote [']
// note [‘] is a different character
{
...
// add/delete mappings as you see fit
{
    ...
    m_match["Á"] = "A"; // Latin A with mcute
